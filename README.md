...
- **Keyboard-first navigation** – Move with ↑/↓, expand with →, collapse with ←, recursively expand/collapse subtasks with Shift+→/Shift+←, reorder with M+↑/↓, duplicate with ⌘D, Shift+Tab to toggle focus, Return to add, Esc to clear.
