...
let taskListAnimationsGroupEnabledPreferenceKey = "taskListAnimationsGroupEnabledPreference" // Group toggle for Task List animations
let expandCollapseAnimationsGroupEnabledPreferenceKey = "expandCollapseAnimationsGroupEnabledPreference" // Group toggle for Expand/Collapse animations
let hoverHighlightsAnimationEnabledPreferenceKey = "hoverHighlightsAnimationEnabledPreference" // Toggle hover background animations
let pinRotationAnimationEnabledPreferenceKey = "pinRotationAnimationEnabledPreference" // Toggle pin button rotation animation
let suggestionBoxAnimationEnabledPreferenceKey = "suggestionBoxAnimationEnabledPreference" // Toggle suggestion dropdown animations
